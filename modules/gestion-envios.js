...
async function sincronizarDesdeSupabase(){setSincronizando(true);try{
  ...
  const COLS='id,codigo,cliente,destinatario,telefono,direccion,comuna,referencia,fecha,estado,mensajero,monto,en_un_cambio,nota,nota_admin,fuente,peso,valor_siniestro,updated_at,created_at,aviso_tardio';
